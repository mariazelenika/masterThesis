...
namespace UnityEngine.XR.Interaction.Toolkit.Samples.Hands
{
    ...
    public class MetaSystemGestureDetector : MonoBehaviour
    {
        ...
        [SerializeField]
        InputActionProperty m_AimFlagsAction = new(new InputAction(expectedControlType: "Integer"));
        ...
        readonly BindableEnum<SystemGestureState> m_SystemGestureState = new(checkEquality: false);
